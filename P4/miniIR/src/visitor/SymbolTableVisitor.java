 ...
 */
public class SymbolTableVisitor<R> implements GJNoArguVisitor<R> {
   ...
   public R visit(VarDeclaration n) {
      ...
      if(current instanceof ClassTable) {
    	  ...
    	  _variable.position = MiniIRBuilder.temp++;
